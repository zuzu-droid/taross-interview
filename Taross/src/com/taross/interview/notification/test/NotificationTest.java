...
public class NotificationTest {
	...
	public void testNotifyEmail() {
		...
		assertEquals("Email sent to [tarossservice@gmail.com] with Message [Do you find this test interesting?]", outContent.toString());
	}
	...
	public void testNotifyPush() {
		...
		assertEquals("Notification sent to [tarossservice@gmail.com] with Message [What's the benefit of dependency injection?]", outContent.toString());
